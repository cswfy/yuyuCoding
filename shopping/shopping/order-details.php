		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart-description item">商品圖</th>
					<th class="cart-product-name item">商品名稱</th>
			
					<th class="cart-qty item">數量</th>
					<th class="cart-sub-total item">每份價格</th>
					<th class="cart-total item">總計</th>
					<th class="cart-total item">付款方式</th>
					<th class="cart-description item">訂單日期</th>
					<th class="cart-total last-item">修改</th>
				</tr>
			</thead><!-- /thead -->
...
?>
				<tr>
					...
					<td>
 <a href="javascript:void(0);" onClick="popUpWindow('track-order.php?oid=<?php echo htmlentities($row['orderid']);?>');" title="追蹤訂單">
					追蹤</td>
				</tr>
<?php $cnt=$cnt+1;} } else { ?>
				<tr><td colspan="8">無效資訊</td></tr>
				<?php } ?>
			</tbody><!-- /tbody -->
		</table><!-- /table -->
