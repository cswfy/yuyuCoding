...
{?>
									...
									<strong>恭喜!</strong>	<?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="更新成功");?>
									</div>
<?php } ?>
...
{?>
									<div class="alert alert-error">
										<button type="button" class="close" data-dismiss="alert">×</button>
									<strong>喔!</strong> 	<?php echo htmlentities($_SESSION['delmsg']);?><?php echo htmlentities($_SESSION['delmsg']="已刪除");?>
									</div>
<?php } ?>
...
<label class="control-label" for="basicinput">類別</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">經銷商</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">原價</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">商品價格</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">商品運費</label>
<div class="controls">
...
<div class="controls">
<img src="productimages/<?php echo htmlentities($pid);?>/<?php echo htmlentities($row['productImage1']);?>" width="200" height="100"> <a href="update-image1.php?id=<?php echo $row['id'];?>">更換圖片</a>
</div>
</div>
...
<div class="controls">
<img src="productimages/<?php echo htmlentities($pid);?>/<?php echo htmlentities($row['productImage2']);?>" width="200" height="100"> <a href="update-image2.php?id=<?php echo $row['id'];?>">更換圖片</a>
</div>
</div>
...
<div class="controls">
<img src="productimages/<?php echo htmlentities($pid);?>/<?php echo htmlentities($row['productImage3']);?>" width="200" height="100"> <a href="update-image3.php?id=<?php echo $row['id'];?>">變更圖片</a>
</div>
</div>
<?php } ?>
	<div class="control-group">
											<div class="controls">
												<button type="submit" name="submit" class="btn">更新</button>
											</div>
										</div>
									</form>
							</div>
