...
{?>
									...
									<strong>恭喜!</strong>	<?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?>
									</div>
<?php } ?>
...
{?>
									<div class="alert alert-error">
										<button type="button" class="close" data-dismiss="alert">×</button>
									<strong>唉呦喂啊!</strong> 	<?php echo htmlentities($_SESSION['delmsg']);?><?php echo htmlentities($_SESSION['delmsg']="");?>
									</div>
<?php } ?>
...
<div class="control-group">
<label class="control-label" for="basicinput">子類別名稱</label>
<div class="controls">
<input type="text" placeholder="輸入子類別名稱"  name="subcategory" class="span8 tip" required>
</div>
</div>
	...
	<div class="control-group">
											<div class="controls">
												<button type="submit" name="submit" class="btn">建立</button>
											</div>
										</div>
									</form>
							</div>
