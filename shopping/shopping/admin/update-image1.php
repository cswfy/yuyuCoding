...
{?>
									...
									<strong>喔耶! 更新起來!</strong>	<?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?>
									</div>
<?php } ?>
...
<div class="control-group">
<label class="control-label" for="basicinput">目前商品圖1</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">新商品圖1</label>
<div class="controls">
