...
header('location:login.php');
	...
	if(isset($_POST['update']))
	{
		...
		if($query)
		{
echo "<script>alert('您的資訊已更新');</script>";
		}
	}
...
echo "<script>alert('密碼變更成功!! 請重新登入^_^');</script>";
}
else
{
...
<div class="form-group">
					    <label class="info-title" for="name">姓名<span>*</span></label>
			 ...
			 <input type="email" class="form-control unicase-form-control text-input" id="exampleInputEmail1" value="<?php echo $row['email'];?>" readonly>
					  ...
					  <div class="form-group">
					    <label class="info-title" for="Contact No.">聯絡方式. <span>*</span></label>
...
<div class="form-group">
					    <label class="info-title" for="Current Password">目前密碼<span>*</span></label>
						...
						<div class="form-group">
					    <label class="info-title" for="New Password">新密碼 <span>*</span></label>
			 <input type="password" class="form-control unicase-form-control text-input" id="newpass" name="newpass">
					  </div>
					  <div class="form-group">
					    <label class="info-title" for="Confirm Password">確認新密碼 <span>*</span></label>
					    <input type="password" class="form-control unicase-form-control text-input" id="cnfpass" name="cnfpass" required="required" >
					  </div>
					  <button type="submit" name="submit" class="btn-upper btn btn-primary checkout-page-button">變更 </button>
					</form> 
