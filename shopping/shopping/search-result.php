	...
	if(isset($_SESSION['cart'][$id])){
		...
		if(mysqli_num_rows($query_p)!=0){
			...
			$_SESSION['cart'][$row_p['id']]=array("quantity" => 1, "price" => $row_p['productPrice']);
						echo "<script>alert('吼吼吼已在購物車內')</script>";
...
echo "<script>alert('商品成功加入璦玻珥願望清單^_^');</script>";
...
<header class="header-style-1">
	...
	<!-- ==== top-header.php 最頂端的MENU =-->
<?php include('includes/top-header.php');?>
<!-- top-header.php 最頂端的MENU end -->

<!-- main-header.php 含搜尋區域 -->
...
<div class="side-menu animate-dropdown outer-bottom-xs">
    <div class="head"><i class="icon fa fa-align-justify fa-fw"></i>子類別</div>        
...
<!-- ================================== TOP NAVIGATION : END ================================== -->	            <div class="sidebar-module-container">
	            	<h3 class="section-title">來自</h3>
	            	<div class="sidebar-filter">
		            	<!-- ============================================== SIDEBAR CATEGORY ============================================== -->
<div class="sidebar-widget wow fadeInUp outer-bottom-xs ">
	<div class="widget-header m-t-20">
		<h4 class="widget-title">商品類別</h4>
	</div>
...
{?>							
	...
	<div class="product">		
	  ...
	  <?php } } else {?>
		...
		<div class="col-sm-6 col-md-4 wow fadeInUp"> <h3>未找到商品</h3>
		</div>
