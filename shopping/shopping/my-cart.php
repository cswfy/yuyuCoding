...
if(isset($_POST['submit'])){
		...
		foreach($_POST['quantity'] as $key => $val){
			...
			echo "<script>alert('您的購物車已更新');</script>";
		}
	}
...
if(!empty($_SESSION['cart'])){
		foreach($_POST['remove_code'] as $key){
			...
			echo "<script>alert('購物車已清空');</script>";
	}
}
// 插入商品到訂單的table內
...
// 更新帳單地址
	...
	if(isset($_POST['update']))
	{
		...
		if($query)
		{
echo "<script>alert('帳單地址更新成功');</script>";
		}
	}
...
// 宅配地址更新
	...
	if(isset($_POST['shipupdate']))
	{
		...
		if($query)
		{
echo "<script>alert('宅配地址更新成功');</script>";
		}
	}
...
if(!empty($_SESSION['cart'])){
	?>
		<table class="table table-bordered">
			<thead>
				<tr>
					<th class="cart-romove item">移除</th>
					<th class="cart-description item">圖片</th>
					<th class="cart-product-name item">商品名稱</th>
			
					<th class="cart-qty item">數量</th>
					<th class="cart-sub-total item">每份價格</th>
					<th class="cart-sub-total item">運費</th>
					<th class="cart-total last-item">總計</th>
				</tr>
			</thead><!-- /thead -->
			<tfoot>
				<tr>
					<td colspan="7">
						<div class="shopping-cart-btn">
							<span class="">
								<a href="index.php" class="btn btn-upper btn-primary outer-left-xs">繼續購物</a>
								<input type="submit" value="清除商品" class="btn btn-upper btn-primary pull-right outer-right-xs">
							</span>
...
?>
					...
					<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "TWD"." ".$row['productPrice']; ?>.00</span></td>
<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "TWD"." ".$row['shippingCharge']; ?>.00</span></td>
...
$_SESSION['pid']=$pdtid;
	...
	<table class="table table-bordered">
		<thead>
			<tr>
				<th>
					<span class="estimate-title">宅配地址</span>
				</th>
			</tr>
		</thead>
		<tbody>
...
<div class="form-group">
					    <label class="info-title" for="Billing Address">帳單地址<span>*</span></label>
						...
						<div class="form-group">
					    <label class="info-title" for="Billing State ">帳單狀態  <span>*</span></label>
			 <input type="text" class="form-control unicase-form-control text-input" id="bilingstate" name="bilingstate" value="<?php echo $row['billingState'];?>" required>
					  ...
					  <div class="form-group">
					    <label class="info-title" for="Billing City">城市 <span>*</span></label>
 ...
 <div class="form-group">
					    <label class="info-title" for="Billing Pincode">帳單驗證碼<span>*</span></label>
					  ...
					  <button type="submit" name="update" class="btn-upper btn btn-primary checkout-page-button">更新</button>
...
<div class="col-md-4 col-sm-12 estimate-ship-tax">
	<table class="table table-bordered">
		<thead>
			<tr>
				<th>
					<span class="estimate-title">帳單地址</span>
				</th>
			</tr>
		</thead>
		<tbody>
...
<div class="form-group">
					    <label class="info-title" for="Shipping Address">宅配地址<span>*</span></label>
						...
						<div class="form-group">
					    <label class="info-title" for="Billing State ">宅配狀態 <span>*</span></label>
			 <input type="text" class="form-control unicase-form-control text-input" id="shippingstate" name="shippingstate" value="<?php echo $row['shippingState'];?>" required>
					  ...
					  <div class="form-group">
					    <label class="info-title" for="Billing City">宅配城市 <span>*</span></label>
 ...
 <div class="form-group">
					    <label class="info-title" for="Billing Pincode">宅配驗證碼 <span>*</span></label>
					  ...
					  <button type="submit" name="shipupdate" class="btn-upper btn btn-primary checkout-page-button">更新</button>
					<?php } ?>
			...
			<tr>
				<th>
					...
					<div class="cart-grand-total">
						總共<span class="inner-left-md"><?php echo $_SESSION['tp']="$totalprice". ".00"; ?></span>
					</div>
				</th>
			</tr>
		</thead><!-- /thead -->
				...
				<tr>
					<td>
						<div class="cart-checkout-btn pull-right">
							<button type="submit" name="ordersubmit" class="btn btn-primary">結帳</button>
