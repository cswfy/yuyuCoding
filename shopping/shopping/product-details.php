	...
	if(isset($_SESSION['cart'][$id])){
		...
		if(mysqli_num_rows($query_p)!=0){
			...
			$_SESSION['cart'][$row_p['id']]=array("quantity" => 1, "price" => $row_p['productPrice']);
					echo "<script>alert('商品已加入購物車囉^_^')</script>";
...
echo "<script>alert('商品已加入許願清單');</script>";
...
<html lang="en">
	<head>
		...
		<link rel="shortcut icon" href="assets/images/coffee.ico">
	</head>
    <body class="cnt-home">
...
<div class="sidebar-widget outer-bottom-xs wow fadeInUp">
	<h3 class="section-title">商品類別</h3>
					...
					<div class="products">
						...
						<div class="product-info text-left m-t-20">
							...
							<div class="product-price">	
								<span class="price">
									TWD. <?php echo htmlentities($rws['productPrice']);?>.00
								</span>
									
							    <span class="price-before-discount">TWD.<?php echo htmlentities($row['productPriceBeforeDiscount']);?></span>					
						...
						<div class="cart clearfix animate-effect">
							<div class="action">
								...
								<?php if($row['productAvailability']=='Yes'){?>
										<button class="btn btn-primary icon" data-toggle="dropdown" type="button">
								<i class="fa fa-shopping-cart"></i>													
							</button>
							<a href="category.php?page=product&action=add&id=<?php echo $row['id']; ?>">
							<button class="btn btn-primary" type="button">加入購物車</button></a>
								<?php } else {?>
							<div class="action" style="color:red">無庫存</div>
					<?php } ?>
...
?>		
							<div class="rating-reviews m-t-20">
								<div class="row">
									...
									<div class="col-sm-8">
										<div class="reviews">
											<a href="#" class="lnk">(<?php echo htmlentities($num);?> 評論)</a>
										</div>
									</div>
								</div><!-- /.row -->		
							</div><!-- /.rating-reviews -->
...
<div class="stock-container info-container m-t-10">
							...
							<div class="price-container info-container m-t-20">
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="price-box">
											<span class="price">TWD. <?php echo htmlentities($row['productPrice']);?></span>
											<span class="price-strike">TWD.<?php echo htmlentities($row['productPriceBeforeDiscount']);?></span>
										</div>
									</div>
									...
									<div class="col-sm-6">
										<div class="favorite-button m-t-10">
											<a class="btn btn-primary" data-toggle="tooltip" data-placement="right" title="願望清單" href="product-details.php?pid=<?php echo htmlentities($row['id'])?>&&action=wishlist">
							...
							<div class="quantity-container info-container">
								<div class="row">
									...
									<div class="col-sm-7">
<?php if($row['productAvailability']=='Yes'){?>
										<a href="product-details.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="btn btn-primary"><i class="fa fa-shopping-cart inner-right-vs"></i> 加入購物車</a>
													<?php } else {?>
							<div class="action" style="color:red">無庫存</div>
					<?php } ?>
									</div>
					...
					<div class="row">
						<div class="col-sm-3">
							<ul id="product-tabs" class="nav nav-tabs nav-tab-cell">
								...
								<li><a data-toggle="tab" href="#review">評論</a></li>
...
?>
											...
											<div class="reviews" style="border: solid 1px #000; padding-left: 2% ">
												<div class="review">
													...
													<div class="text"><b>質感 :</b>  <?php echo htmlentities($rvw['quality']);?> Star</div>
													<div class="text"><b>價格 :</b>  <?php echo htmlentities($rvw['price']);?> Star</div>
													<div class="text"><b>CP值 :</b>  <?php echo htmlentities($rvw['value']);?> Star</div>
										...
										<div class="product-add-review">
											<h4 class="title">寫下評論，讓璦玻珥咖啡有機會為您提供更好的服務 !</h4>
														...
														<div class="row">
															<div class="col-sm-6">
																<div class="form-group">
																	<label for="exampleInputName">名字 <span class="astk">*</span></label>
															...
															<div class="col-md-6">
																<div class="form-group">
																	<label for="exampleInputReview">寫下你的評論 <span class="astk">*</span></label>
...
<textarea class="form-control txt txt-review" id="exampleInputReview" rows="4" placeholder="" name="review" required="required"></textarea>
														...
														<div class="action text-right">
															<button name="submit" class="btn btn-primary btn-upper">提交評論</button>
														</div><!-- /.action -->
...
while($rw=mysqli_fetch_array($qry))
{
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					TWD.<?php echo htmlentities($rw['productPrice']);?>			</span>
										     <span class="price-before-discount">TWD.
				...
				<div class="action">
					<ul class="list-unstyled">
						...
						<a href="product-details.php?page=product&action=add&id=<?php echo $rw['id']; ?>" class="lnk btn btn-primary">加入購物車</a>
