...
?>
						...
						<div class="rating">
							...
							<span class="review">( <?php echo htmlentities($num);?> 評論 )</span>
						</div>
						<?php } ?>
						<div class="price">Rs. 
					...
					<td class="col-md-2">
						<a href="my-wishlist.php?page=product&action=add&id=<?php echo $row['pid']; ?>" class="btn-upper btn btn-primary">加入購物車</a>
					</td>
				...
				<?php } } else{ ?>
				<tr>
					<td style="font-size: 18px; font-weight:bold ">你的願望清單是空滴>_<</td>
