...
if(isset($_GET['action']) && $_GET['action']=="add"){
	...
	if(isset($_SESSION['cart'][$id])){
		...
		echo "<script>alert('商品已經在購物車裡了')</script>";
...
<div id="hero" class="homepage-slider3">
	<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
		<div class="full-width-slider">	
			<div class="item" style="background-image: url(assets/images/sliders/sli1.png);">
				<!-- /.container-fluid -->
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
	    
	    <div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(assets/images/sliders/sli2.png);">
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading green">咖啡豆皆有優惠</h4>
						</div>
					</div>	
					<h6 class="text">保證比實體店便宜</h6>
				</div>
			</div><!-- .col -->
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading orange">免運費</h4>
						</div>
					</div>
					<h6 class="text">活動期間在璦玻珥網站購物免運費</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading red">璦玻珥專屬禮品</h4>
						</div>
					</div>
					<h6 class="text">活動期間在璦玻珥商品送精美小禮品</h6>	
				</div>
			</div><!-- .col -->
		</div><!-- /.row -->
...
<!-- ============================================== INFO BOXES : END ============================================== -->		
		...
		<div id="product-tabs-slider" class="scroll-tabs inner-bottom-vs  wow fadeInUp">
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">特色商品</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					<li class="active"><a href="#all" data-toggle="tab">全部</a></li>
					<li><a href="#books" data-toggle="tab">咖啡豆</a></li>
					<li><a href="#furniture" data-toggle="tab">濾掛咖啡</a></li>
				</ul><!-- /.nav-tabs -->
			</div>
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					TWD.<?php echo htmlentities($row['productPrice']);?>			</span>
		...
		<?php if($row['productAvailability']=='Yes'){?>
					<div class="action"><a href="index.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="lnk btn btn-primary">加入購物車</a></div>
				<?php } else {?>
								...
								<div class="row product-micro-row">
									...
									<div class="col col-xs-6">
										<div class="product-info">
											...
											<div class="product-price">	
												<span class="price">
													TWD. <?php echo htmlentities($row['productPrice']);?>
												</span>
